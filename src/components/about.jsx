...
function About() {
    ...
    return (
        <div className="about-container">
            <h1 onClick={() => setShowPersonalInfo(!showPersonalInfo)} style={{ cursor: 'pointer' }}>
                ประวัติส่วนตัว {showPersonalInfo ? ' ▼' : <span style={{ fontSize: '0.5em' }}>คลิ๊กเพื่อดูข้อมูล ▲</span>}
            </h1>
            {showPersonalInfo && (
            ...
            <h1 onClick={() => setShowEducation(!showEducation)} style={{ cursor: 'pointer' }}>
                ประวัติการศึกษา {showEducation ? '▼' : <span style={{ fontSize: '0.5em' }}>คลิ๊กเพื่อดูข้อมูล ▲</span>}
            </h1>
            {showEducation && (
                <>
                    ...
                    <div className="education-card styled-card">
                        ...
                        <p><strong>แผนที่:</strong> <a href="https://www.google.com/maps?q=13.1207784,100.9188866" target="_blank" rel="noopener noreferrer">ดูแผนที่</a></p>
                    </div>
                </>
            )}
